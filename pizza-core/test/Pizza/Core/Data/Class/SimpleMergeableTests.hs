...
module Pizza.Core.Data.Class.SimpleMergeableTests where
...
simpleMergeableTests =
  testGroup
    ...
    [ testGroup
        ...
        [ testCase "SBool" $ do
            mrgIte (SSBool "a") (SSBool "b") (SSBool "c") @=? ITE (SSBool "a") (SSBool "b") (SSBool "c"),
          testCase "()" $ do
            mrgIte (SSBool "a") () () @=? (),
          ...
          testCase "MaybeT (UnionMBase SBool) SBool" $ do
            ...
            mrgIte (SSBool "a") l r @=? res
            mrgIte1 (SSBool "a") l r @=? res
