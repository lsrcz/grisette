...
module Pizza.Core.Data.UnionBaseTests where
    ...
    [ testGroup
      ...
      testGroup
        ...
        [ testGroup
            ...
            [ testCase "true" $ do
                ifWithStrategy mergingStrategy (CBool True) (Single (1 :: Integer)) (Single 2) @=? Single 1,
              testCase "false" $ do
                ifWithStrategy mergingStrategy (CBool False) (Single (1 :: Integer)) (Single 2) @=? Single 2
            ],
