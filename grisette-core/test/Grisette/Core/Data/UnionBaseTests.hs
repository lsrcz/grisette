...
instance (SymBoolOp bool, GMergeable bool a, GMergeable bool b, GMergeable bool c) => GMergeable bool (TripleSum a b c) where
  gmergingStrategy =
    SortedStrategy
      ...
      ( \case
          0 -> gwrapStrategy gmergingStrategy TS1 (\(TS1 x) -> x)
          1 -> gwrapStrategy gmergingStrategy TS2 (\(TS2 x) -> x)
          2 -> gwrapStrategy gmergingStrategy TS3 (\(TS3 x) -> x)
          _ -> error "Bad"
      )
    ...
    [ testGroup
      ...
      testGroup
        ...
        [ testGroup
            ...
            [ testCase "true" $ do
                ifWithStrategy gmergingStrategy (CBool True) (Single (1 :: Integer)) (Single 2) @=? Single 1,
              testCase "false" $ do
                ifWithStrategy gmergingStrategy (CBool False) (Single (1 :: Integer)) (Single 2) @=? Single 2
            ],
          let a = ifWithStrategy gmergingStrategy (SSBool "a") (Single (1 :: Integer)) (Single 2)
           in testGroup
                "ifWithStrategy with condition equal to sub conditions"
                [ testCase "ifTrue" $ do
                    ifWithStrategy gmergingStrategy (SSBool "a") a (Single 3)
                      @=? If 1 True (SSBool "a") (Single 1) (Single 3),
                  testCase "ifFalse" $ do
                    ifWithStrategy gmergingStrategy (SSBool "a") (Single 0) a
                      @=? If 0 True (SSBool "a") (Single 0) (Single 2)
                ],
          testCase "ifWithStrategy with simple mergeables" $ do
            ifWithStrategy gmergingStrategy (SSBool "a") (Single (SSBool "b")) (Single (SSBool "c"))
          ...
          testGroup
            ...
            [ testGroup
                ...
                [ testGroup
                    "idxt < idxf"
                    [ testCase "Integer" $
                        ifWithStrategy gmergingStrategy (SSBool "a") (Single (1 :: Integer)) (Single 2)
                          @=? If 1 True (SSBool "a") (Single 1) (Single 2),
                      testCase "Maybe Integer" $
                        ifWithStrategy gmergingStrategy (SSBool "a") (Single Nothing) (Single (Just (2 :: Integer)))
                  ...
                  testGroup
                    ...
                    [ testGroup
                        ...
                        [ testCase "Integer" $
                            ifWithStrategy gmergingStrategy (SSBool "a") (Single (1 :: Integer)) (Single 1)
                              @=? Single 1,
                          testCase "Maybe Integer" $
                            ifWithStrategy gmergingStrategy (SSBool "a") (Single (Just (SSBool "b"))) (Single (Just (SSBool "c")))
                              @=? Single (Just (ITE (SSBool "a") (SSBool "b") (SSBool "c")))
                        ],
                      testGroup
                        "idxt == idxf but not terminal"
                        [ testCase "Maybe Integer" $
                            ifWithStrategy gmergingStrategy (SSBool "a") (Single (Just (1 :: Integer))) (Single (Just (2 :: Integer)))
                  ...
                  testGroup
                    "idxt > idxf"
                    [ testCase "Integer" $
                        ifWithStrategy gmergingStrategy (SSBool "a") (Single (2 :: Integer)) (Single 1)
                          @=? If 1 True (Not $ SSBool "a") (Single 1) (Single 2),
                      testCase "Maybe Integer" $
                        ifWithStrategy gmergingStrategy (SSBool "a") (Single (Just (2 :: Integer))) (Single Nothing)
              ...
              testGroup
                ...
                [ testGroup
                    ...
                    [ testCase "Degenerated case with idxt < idxf" $ do
                        ...
                        ifWithStrategy gmergingStrategy (SSBool "b") (Single Nothing) x
                          @=? If
                            Nothing
                            True
                            (SSBool "b")
                      ...
                      let x =
                       ...
                       in testGroup
                            ...
                            [ testCase "sub-idxt < sub-idxft" $
                                ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Just 0) x
                                  @=? If
                                    (Just 0)
                                    True
                                    (SSBool "b")
                              ...
                              testCase "sub-idxt == sub-idxft" $
                                ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Just 1) x
                                  @=? If (Just 1) True (Or (SSBool "b") (SSBool "a")) (Single $ Just 1) (Single (Just 3)),
                              testCase "subidxft < sub-idxt < sub-idxff" $
                                ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Just 2) x
                                  @=? If
                                    (Just 1)
                                    True
                              ...
                              testCase "sub-idxt == sub-idxff" $
                                ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Just 3) x
                                  @=? If (Just 1) True (And (Not (SSBool "b")) (SSBool "a")) (Single $ Just 1) (Single (Just 3)),
                              testCase "sub-idxff < sub-idxt" $
                                ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Just 4) x
                                  @=? If
                                    (Just 1)
                                    True
                                    (And (Not (SSBool "b")) (SSBool "a"))
                      ...
                      testCase "Degenerated case with idxt > idxf" $ do
                        ...
                        ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Right (1 :: Integer)) x
                          @=? If
                            (Left 1)
                            True
                            (Not $ SSBool "b")
                  ...
                  testCase "idxt < idxft" $ do
                    let x =
                          ifWithStrategy
                            ...
                            (Single (1 :: Integer))
                            (Single (3 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "b") (Single 0) x
                  ...
                  testCase "idxt == idxft" $ do
                    ...
                    ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Left 0) x
                      @=? If
                        (Left 0)
                        True
                  ...
                  testCase "idxt > idxft" $ do
                    let x =
                          ifWithStrategy
                            ...
                            (Single $ Left (1 :: Integer))
                            (Single $ Right (3 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Right 0) x
                      @=? If
                        (Left 1)
                        True
                        (And (Not (SSBool "b")) (SSBool "a"))
                    ...
                    [ testCase "Degenerated case with idxt < idxf" $ do
                        let x =
                              ifWithStrategy
                                ...
                                (Single (Left (1 :: Integer)))
                                (Single (Left (2 :: Integer)))
                        ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Right (2 :: Integer))
                          @=? If
                            (Left 1)
                            True
                            (SSBool "b")
                      ...
                      let x =
                       ...
                       in testGroup
                            ...
                            [ testCase "sub-idxf < sub-idxtt" $
                                ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Just 0)
                                  @=? If
                                    (Just 0)
                                    True
                                    (Not (SSBool "b"))
                                    ...
                                    (If (Just 1) True (SSBool "a") (Single $ Just 1) (Single (Just 3))),
                              testCase "sub-idxf == sub-idxtt" $
                                ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Just 1)
                                  @=? If (Just 1) True (Or (Not $ SSBool "b") (SSBool "a")) (Single $ Just 1) (Single (Just 3)),
                              testCase "sub-idxtt < sub-idxf < sub-idxtf" $
                                ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Just 2)
                                  @=? If
                                    (Just 1)
                                    True
                              ...
                              testCase "sub-idxf == sub-idxtf" $
                                ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Just 3)
                                  @=? If (Just 1) True (And (SSBool "b") (SSBool "a")) (Single $ Just 1) (Single (Just 3)),
                              testCase "sub-idxtf < sub-idxf" $
                                ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Just 4)
                                  @=? If
                                    (Just 1)
                                    True
                                    (And (SSBool "b") (SSBool "a"))
                      ...
                      testCase "Degenerated case with idxt > idxf" $ do
                        ...
                        ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Left (1 :: Integer))
                          @=? If
                            (Left 1)
                            True
                            (Not $ SSBool "b")
                  ...
                  testCase "idxtt < idxf" $ do
                    let x =
                          ifWithStrategy
                            ...
                            (Single $ Left (1 :: Integer))
                            (Single $ Right (3 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Right 0)
                      @=? If
                        (Left 1)
                        True
                        (And (SSBool "b") (SSBool "a"))
                  ...
                  testCase "idxtt == idxf" $ do
                    let x =
                          ifWithStrategy
                            ...
                            (Single $ Left (1 :: Integer))
                            (Single $ Right (3 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "b") x (Single $ Left 0)
                      @=? If
                        (Left 0)
                        True
                  ...
                  testCase "idxtt > idxf" $ do
                    let x =
                          ifWithStrategy
                            ...
                            (Single (1 :: Integer))
                            (Single (3 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "b") x (Single 0)
              ...
              testGroup
                ...
                [ testCase "Degenerate to Single/If when idxtt == idxtf" $ do
                    let x = ifWithStrategy gmergingStrategy (SSBool "a") (Single $ Left (1 :: Integer)) (Single $ Left (2 :: Integer))
                    let y = ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Left (1 :: Integer)) (Single $ Right (2 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "c") x y
                      @=? If
                        (Left 1)
                        True
                  ...
                  testCase "Degenerate to Single/If when idxff == idxft" $ do
                    let x = ifWithStrategy gmergingStrategy (SSBool "a") (Single $ Left (1 :: Integer)) (Single $ Left (2 :: Integer))
                    let y = ifWithStrategy gmergingStrategy (SSBool "b") (Single $ Left (1 :: Integer)) (Single $ Right (2 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "c") y x
                      @=? If
                        (Left 1)
                        True
                  ...
                  testCase "Non-degenerated case when idxtt < idxft" $ do
                    let x = ifWithStrategy gmergingStrategy (SSBool "a") (Single $ TS1 (1 :: Integer)) (Single $ TS2 (2 :: Integer))
                    let y = ifWithStrategy gmergingStrategy (SSBool "b") (Single $ TS2 (1 :: Integer)) (Single $ TS3 (2 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "c") x y
                      @=? If
                        (TS1 1)
                        True
                  ...
                  testCase "Non-degenerated case when idxtt == idxft" $ do
                    let x = ifWithStrategy gmergingStrategy (SSBool "a") (Single $ TS1 (1 :: Integer)) (Single $ TS2 (2 :: Integer))
                    let y = ifWithStrategy gmergingStrategy (SSBool "b") (Single $ TS1 (2 :: Integer)) (Single $ TS3 (2 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "c") x y
                      @=? If
                        (TS1 1)
                        True
                  ...
                  testCase "Non-degenerated case when idxtt > idxft" $ do
                    let x = ifWithStrategy gmergingStrategy (SSBool "a") (Single $ TS2 (1 :: Integer)) (Single $ TS3 (2 :: Integer))
                    let y = ifWithStrategy gmergingStrategy (SSBool "b") (Single $ TS1 (1 :: Integer)) (Single $ TS2 (2 :: Integer))
                    ifWithStrategy gmergingStrategy (SSBool "c") x y
                      @=? If
                        (TS1 1)
                        True
      ...
      testGroup
        ...
        [ testCase "fullReconstruct should work" $ do
            ...
            fullReconstruct gmergingStrategy z
              @=? If
                (Left 1)
                True
                (ITE (SSBool "c") (Not $ SSBool "a") (Not $ SSBool "b"))
