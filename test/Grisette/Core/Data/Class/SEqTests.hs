              ...
              testGroup
                ...
                [ testCase "Same length 1" $
                  ...
                  testCase "length 1 vs length 2" $
                    [ssymBool "a"] ==~ [ssymBool "c", ssymBool "d"]
                      @=? conBool False
                ]
            ],
          testGroup
              ...
              testGroup
                ...
                [ testCase "Nothing vs Nothing" $
                  ...
                  testCase "Just vs Just" $
                    Just (ssymBool "a") ==~ Just (ssymBool "b")
                      @=? ssymBool "a" ==~ ssymBool "b"
                ]
            ],
          testGroup
      ...
      testGroup
        ...
        [ testGroup
            ...
            [ testCase "A1 vs A1" $
              ...
              testCase "A2 vs A2" $
                A2 (ssymBool "a") ==~ A2 (ssymBool "b")
                  @=? ssymBool "a" ==~ ssymBool "b",
              testCase "A2 vs A3" $
                A2 (ssymBool "a") ==~ A3 (ssymBool "b") (ssymBool "c")
                  @=? conBool False,
              testCase "A3 vs A1" $
                A3 (ssymBool "a") (ssymBool "b") ==~ A1 @=? conBool False,
              testCase "A3 vs A2" $
                A3 (ssymBool "a") (ssymBool "b") ==~ A2 (ssymBool "c")
                  @=? conBool False,
              testCase "A3 vs A3" $
