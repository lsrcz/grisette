...
module Grisette.Core.Data.DynBVTests (dynBVTests) where
...
import Data.Word
import GHC.TypeNats
import Grisette (SizedBV (sizedBVConcat))
...
class
  ...
  DynBVAssociate dbv bv sbv bv8 bv32 bv64
    | dbv -> bv bv8 bv32 bv64

instance DynBVAssociate DynIntN IntN SomeIntN Int8 Int32 Int64

instance DynBVAssociate DynWordN WordN SomeWordN Word8 Int32 Word64
