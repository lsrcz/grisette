...
mergeableTests =
  testGroup
    ...
    [ testGroup
        ...
        [ let SimpleStrategy f = grootStrategy :: GMergingStrategy SBool SBool
           in testGroup
                "Mergeable for SBool"
          ...
          testGroup
            ...
            [ testGroup
              ...
              testGroup
                "Either SBool SBool"
                [ testCase "Left v" $ do
                    let (idxsL, SimpleStrategy fL) = gresolveStrategy @SBool grootStrategy (Left (SSBool "a") :: Either SBool SBool)
                    idxsL @=? [DynamicSortedIdx False]
                    fL (SSBool "a") (Left $ SSBool "b") (Left $ SSBool "c")
                      @=? Left (ITE (SSBool "a") (SSBool "b") (SSBool "c")),
                  testCase "Right v" $ do
                    let (idxsR, SimpleStrategy fR) = gresolveStrategy @SBool grootStrategy (Right (SSBool "a") :: Either SBool SBool)
          ...
          testGroup
            ...
            [ testGroup
              ...
              testCase "Maybe SBool / Just v" $ do
                let (idxsJ, SimpleStrategy fJ) = gresolveStrategy @SBool grootStrategy (Just (SSBool "a") :: Maybe SBool)
          ...
          testGroup
            ...
            [ testCase "BuildStrategyList" $ do
                case gbuildStrategyList @SBool @Integer grootStrategy [1, 2, 3] of
              ...
              testProperty "List for ordered type" $
                ioProperty . \(x :: [Integer]) -> do
                  testMergeableSimpleEquivClass
                    x
                    [DynamicSortedIdx (length x), DynamicSortedIdx $ gbuildStrategyList @SBool grootStrategy x]
                    [(SSBool "a", x, x, x)],
          ...
          testCase "(,)" $
            testMergeableSimpleEquivClass
              ...
              [ DynamicSortedIdx (1 :: Int),
                DynamicSortedIdx $ gbuildStrategyList @SBool grootStrategy [1 :: Integer],
                DynamicSortedIdx (2 :: Int)
              ]
              [ ( SSBool "a",
                  ([1], [SSBool "c", SSBool "d"]),
          ...
          testCase "(,,,,)" $
            testMergeableSimpleEquivClass
              ...
              [ DynamicSortedIdx (1 :: Int),
                ...
                DynamicSortedIdx (1 :: Int),
                DynamicSortedIdx (2 :: Int),
                DynamicSortedIdx $ gbuildStrategyList @SBool grootStrategy [2 :: Integer, 3]
              ]
              [ ( SSBool "a",
          ...
          let f1 :: Maybe SBool -> SBool = \case Just x -> x; Nothing -> (CBool True)
           ...
           in testGroup
                ...
                [ testCase "Simply mergeable result" $ do
                    case grootStrategy :: GMergingStrategy SBool (Maybe SBool -> SBool) of
                      SimpleStrategy f -> do
                  ...
                  testCase "Other mergeable result" $ do
                    case grootStrategy :: GMergingStrategy SBool (Maybe SBool -> Integer) of
                      NoStrategy -> return ()
                      _ -> assertFailure "Bad mergeable strategy type"
                ],
          testGroup
          ...
          testGroup
            ...
            [ testCase "Lazy StateT" $ do
                let SimpleStrategy s = grootStrategy :: GMergingStrategy SBool (StateLazy.StateT Integer (UnionMBase SBool) SBool)
              ...
              testCase "Strict StateT" $ do
                let SimpleStrategy s = grootStrategy :: GMergingStrategy SBool (StateStrict.StateT Integer (UnionMBase SBool) SBool)
          ...
          testCase "ContT" $ do
            let SimpleStrategy s = grootStrategy :: GMergingStrategy SBool (ContT (SBool, Integer) (UnionMBase SBool) (SBool, Integer))
          ...
          testGroup
            ...
            [ testCase "Lazy WriterT" $ do
                let SimpleStrategy s = grootStrategy :: GMergingStrategy SBool (WriterLazy.WriterT Integer (UnionMBase SBool) SBool)
              ...
              testCase "Strict WriterT" $ do
                let SimpleStrategy s = grootStrategy :: GMergingStrategy SBool (WriterStrict.WriterT Integer (UnionMBase SBool) SBool)
          ...
          testCase "ReaderT" $ do
            let SimpleStrategy s = grootStrategy :: GMergingStrategy SBool (ReaderT Integer (UnionMBase SBool) Integer)
