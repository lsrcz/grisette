...
-- |
-- Module      :   Grisette.SymPrim.SymInteger
...
module Grisette.SymPrim.SymInteger (SymInteger (SymInteger)) where
...
import Grisette.SymPrim.AllSyms (AllSyms (allSymsS), SomeSym (SomeSym))
