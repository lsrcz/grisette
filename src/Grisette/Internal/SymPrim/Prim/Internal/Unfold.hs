  ...
  where
    ...
    oneLevel partial' fallback' x y =
      catchError
        ...
        ( \_ ->
            case (x, y) of
              (ITETerm _ _ _ _ ITETerm {} _, ITETerm {}) -> Nothing
              (ITETerm _ _ _ _ _ ITETerm {}, ITETerm {}) -> Nothing
              (ITETerm {}, ITETerm _ _ _ _ ITETerm {} _) -> Nothing
              (ITETerm {}, ITETerm _ _ _ _ _ ITETerm {}) -> Nothing
              (ITETerm _ _ _ cond vt vf, _) ->
                left cond vt vf y partial' fallback'
              (_, ITETerm _ _ _ cond vt vf) ->
...
generalUnaryUnfolded compute =
  unaryUnfoldOnce
    ( \case
        ConTerm _ _ _ lv -> Just $ conTerm $ compute lv
        _ -> Nothing
    )
...
generalBinaryUnfolded compute =
  binaryUnfoldOnce
    ( \l r -> case (l, r) of
        (ConTerm _ _ _ lv, ConTerm _ _ _ rv) -> Just $ conTerm $ compute lv rv
        _ -> Nothing
    )
