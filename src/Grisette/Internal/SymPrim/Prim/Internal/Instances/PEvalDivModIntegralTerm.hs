...
doPevalDefaultDivIntegralTerm (ConTerm _ _ a) (ConTerm _ _ b)
  | b /= 0 = Just $ conTerm $ a `div` b
doPevalDefaultDivIntegralTerm a (ConTerm _ _ 1) = Just a
...
doPevalDefaultDivBoundedIntegralTerm ::
  ...
  Term a ->
  Maybe (Term a)
doPevalDefaultDivBoundedIntegralTerm (ConTerm _ _ a) (ConTerm _ _ b)
  | b /= 0 && (b /= -1 || a /= minBound) = Just $ conTerm $ a `div` b
doPevalDefaultDivBoundedIntegralTerm a (ConTerm _ _ 1) = Just a
...
doPevalDefaultModIntegralTerm ::
  (PEvalDivModIntegralTerm a) => Term a -> Term a -> Maybe (Term a)
doPevalDefaultModIntegralTerm (ConTerm _ _ a) (ConTerm _ _ b)
  | b /= 0 = Just $ conTerm $ a `mod` b
doPevalDefaultModIntegralTerm _ (ConTerm _ _ 1) = Just $ conTerm 0
doPevalDefaultModIntegralTerm _ (ConTerm _ _ (-1)) = Just $ conTerm 0
...
doPevalDefaultQuotIntegralTerm ::
  (PEvalDivModIntegralTerm a) => Term a -> Term a -> Maybe (Term a)
doPevalDefaultQuotIntegralTerm (ConTerm _ _ a) (ConTerm _ _ b)
  | b /= 0 = Just $ conTerm $ a `quot` b
doPevalDefaultQuotIntegralTerm a (ConTerm _ _ 1) = Just a
...
doPevalDefaultQuotBoundedIntegralTerm ::
  ...
  Term a ->
  Maybe (Term a)
doPevalDefaultQuotBoundedIntegralTerm (ConTerm _ _ a) (ConTerm _ _ b)
  | b /= 0 && (b /= -1 || a /= minBound) = Just $ conTerm $ a `quot` b
doPevalDefaultQuotBoundedIntegralTerm a (ConTerm _ _ 1) = Just a
...
doPevalDefaultRemIntegralTerm ::
  (PEvalDivModIntegralTerm a) => Term a -> Term a -> Maybe (Term a)
doPevalDefaultRemIntegralTerm (ConTerm _ _ a) (ConTerm _ _ b)
  | b /= 0 = Just $ conTerm $ a `rem` b
doPevalDefaultRemIntegralTerm _ (ConTerm _ _ 1) = Just $ conTerm 0
doPevalDefaultRemIntegralTerm _ (ConTerm _ _ (-1)) = Just $ conTerm 0
