...
pevalDefaultAndBitsTerm = binaryUnfoldOnce doPevalAndBitsTerm andBitsTerm
  where
    doPevalAndBitsTerm (ConTerm _ _ _ a) (ConTerm _ _ _ b) =
      Just $ conTerm (a .&. b)
    doPevalAndBitsTerm (ConTerm _ _ _ a) b
      | a == zeroBits = Just $ conTerm zeroBits
      | a == complement zeroBits = Just b
    doPevalAndBitsTerm a (ConTerm _ _ _ b)
...
pevalDefaultOrBitsTerm = binaryUnfoldOnce doPevalOrBitsTerm orBitsTerm
  where
    doPevalOrBitsTerm (ConTerm _ _ _ a) (ConTerm _ _ _ b) = Just $ conTerm (a .|. b)
    doPevalOrBitsTerm (ConTerm _ _ _ a) b
      | a == zeroBits = Just b
      | a == complement zeroBits = Just $ conTerm $ complement zeroBits
    doPevalOrBitsTerm a (ConTerm _ _ _ b)
      | b == zeroBits = Just a
...
pevalDefaultXorBitsTerm = binaryUnfoldOnce doPevalXorBitsTerm xorBitsTerm
  where
    ...
    doPevalXorBitsTerm (ConTerm _ _ _ a) b
      | a == zeroBits = Just b
      | a == complement zeroBits = Just $ pevalComplementBitsTerm b
    doPevalXorBitsTerm a (ConTerm _ _ _ b)
      | b == zeroBits = Just a
      | b == complement zeroBits = Just $ pevalComplementBitsTerm a
    doPevalXorBitsTerm a b | a == b = Just $ conTerm zeroBits
    doPevalXorBitsTerm (ComplementBitsTerm _ _ _ i) (ComplementBitsTerm _ _ _ j) =
      Just $ pevalXorBitsTerm i j
    doPevalXorBitsTerm (ComplementBitsTerm _ _ _ i) j =
      Just $ pevalComplementBitsTerm $ pevalXorBitsTerm i j
    doPevalXorBitsTerm i (ComplementBitsTerm _ _ _ j) =
      Just $ pevalComplementBitsTerm $ pevalXorBitsTerm i j
...
pevalDefaultComplementBitsTerm =
  ...
  where
    doPevalComplementBitsTerm (ConTerm _ _ _ a) = Just $ conTerm $ complement a
    doPevalComplementBitsTerm (ComplementBitsTerm _ _ _ a) = Just a
